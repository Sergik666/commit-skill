...
Added the *call for price* form to the product page controller and template, the form collects @name@, @phone@ and @email@, validates them server side and creates a lead in CRM.
...
Added the **call for price** form to the product page: new controller route, QWeb template, and a `crm.lead` created on submit.
